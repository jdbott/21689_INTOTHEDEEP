...
public class PropDetectionPipelineRedHSV extends OpenCvPipeline{
    Telemetry telemetry;
    Mat mat = new Mat();
    ...
    static double LEFT_COLOR_THRESHOLD = 0.04;
    static double CENTER_COLOR_THRESHOLD = 0.02;
    static double RIGHT_COLOR_THRESHOLD = 0.08;
    public PropDetectionPipelineRedHSV(Telemetry t) {telemetry = t;}
