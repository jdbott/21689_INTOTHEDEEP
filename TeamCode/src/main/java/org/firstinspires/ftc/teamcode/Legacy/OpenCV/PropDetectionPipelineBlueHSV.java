...
public class PropDetectionPipelineBlueHSV extends OpenCvPipeline{
    Telemetry telemetry;
    Mat mat = new Mat();
    ...
    static double LEFT_COLOR_THRESHOLD = 0.2; // >20% Blue = Blue prop
    static double CENTER_COLOR_THRESHOLD = 0.14;
    static double RIGHT_COLOR_THRESHOLD = 0.3;
    public PropDetectionPipelineBlueHSV(Telemetry t) {telemetry = t;}
