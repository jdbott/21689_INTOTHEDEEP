//Using this comment to create a merge conflict :)
...
public class PropDetectionPipelineBlueBackboardHSV extends OpenCvPipeline{
    Telemetry telemetry;
    Mat mat = new Mat();
    ...
    static double LEFT_COLOR_THRESHOLD = 0.07; // >20% Blue = Blue prop
    static double CENTER_COLOR_THRESHOLD = 0.05;
    static double RIGHT_COLOR_THRESHOLD = 0.1;
    public PropDetectionPipelineBlueBackboardHSV(Telemetry t) {telemetry = t;}
    ...
    public Mat processFrame(Mat input){
        ...
        Scalar lowHSV = new Scalar(100,75,20);
