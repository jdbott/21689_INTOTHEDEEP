...
public class FollowerConstants {
    ...
    private static final double xMovement = 61.34;
    private static final double yMovement = 50.83;
    ...
    public static double mass = 5.08;
    ...
    // this is for curves
    public static double forwardZeroPowerAcceleration = -60;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    // this is for curves
    public static double lateralZeroPowerAcceleration = -60;
    ...
    // This can be custom set for each Path.
    public static double pathEndTimeoutConstraint = 10.0;
    ...
    public static double holdPointTranslationalScaling = 1.0;

    // This is scales the heading error correction power when the Follower is holding a Point.
    public static double holdPointHeadingScaling = 1.0;
