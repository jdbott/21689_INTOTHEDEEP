...
public class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1745.4680570024964; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1535.299319596501; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1596.4258091689444; // x position of the perpendicular encoder (in tick units)
    }
...
//        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "rightFront"))); // JASON CHASSIS
...
//        par0.setDirection(DcMotorSimple.Direction.FORWARD);
//        par1.setDirection(DcMotorSimple.Direction.REVERSE);
//        perp.setDirection(DcMotorSimple.Direction.FORWARD); // JASON CHASSIS
