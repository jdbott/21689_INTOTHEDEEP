...
public class Point {
    ...
    /**
     * Subtracts another Point from this Point and returns the result as a new Point.
     *
     * @param otherPoint the other specified Point.
     * @return returns the new Point resulting from the subtraction.
     */
    public Point minus(Point otherPoint) {
        double newX = this.x - otherPoint.getX();
        double newY = this.y - otherPoint.getY();
        return new Point(newX, newY, CARTESIAN);
    }
